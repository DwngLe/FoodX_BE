...
public class AdminController {
    ...
    @Operation(
            description =
                    "Xem danh sách các bản cập nhật của nhà hàng dựa trên trạng thái cập nhật (PENDING, ACCEPTED, DENIED)",
    ...
    public APIResponse<Page<RestaurantUpdateDTO>> getUpdateRestaurantList(
            @RequestParam UpdateState updateState, @RequestParam int pageNo, @RequestParam int limit) {
    ...
    public APIResponse<Void> reviewRestaurantUpdate(
            @PathVariable UUID idUpdate, @RequestParam UpdateState updateState) {
    ...
    @Operation(
            description =
                    "Thay đổi trạng thái của 1 nhà hàng bằng cách truyền lên RestaurantState (PENDING, ACTIVE, CLOSED, DENIED, BANNED)",
    ...
    public APIResponse<Void> reviewRestaurantUpdate(
            @PathVariable UUID idRestaurant, @RequestParam RestaurantState restaurantState) {
    ...
    @Operation(
            description =
                    "Xem danh sách các nhà hàng dựa trên trạng thái của nhà hàng (PENDING, ACTIVE, CLOSED, DENIED, BANNED)",
    ...
    public APIResponse<Page<BusinessProofDTO>> getListBusinessProofByState(
            @RequestParam UpdateState state, @RequestParam int pageNo, @RequestParam int limit) {
    ...
    public APIResponse<Void> reviewBusinessProof(
            @PathVariable UUID idBusinessProof, @RequestParam UpdateState updateState) {
